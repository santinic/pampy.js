...
function matchDict(patt, value) {
    ...
    for (let pkey in patt) {
        ...
        for (let vkey in value) {
            ...
            console.log(pkey, 'vs', vkey, '=', [keyMatched, keyExtracted]);
            if (keyMatched) {
                let [valMatched, valExtracted] = matchValue(pval, vval);
                console.log(pval, 'vs', vval, '=', [valMatched, valExtracted]);
                if (valMatched) {
                    ...
                    console.log('still usablke', stillUsablePatternKeys, stillUsableValueKeys)
                }
            }
        }
